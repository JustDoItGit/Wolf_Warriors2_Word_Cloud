from scipy.misc import imread   # 导入第三方库 scipy ：pip3 install scipy
import codecs
from os import path
import jieba    # 导入第三方库 jieba ：pip3 install jieba
from wordcloud import WordCloud # 导入第三方库 wordcloud ：pip3 install wordcloud
...
def draw_wordcloud(file_name):
    ...
    stopwords = ['png','douban','com','href','https','img','img3','class','source','icon','shire',u'有点',u'真的',u'觉得',u'还是',u'一个',u'就是', u'电影', u'你们', u'这么', u'不过', u'但是', u'什么', u'没有', u'这个', u'那个', u'大家', u'比较', u'看到', u'真是',
                 u'除了', u'时候', u'已经', u'可以']
    font = r'/Library/Fonts/STHeiti Light.ttc'
